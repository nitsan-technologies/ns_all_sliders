...
#. **Get it from typo3.org:** You can always get current version from `https://extensions.typo3.org/extension/ns_all_sliders/ <https://extensions.typo3.org/extension/ns_all_sliders/>`_ by downloading either the t3x or zip version. Upload the file afterwards in the Extension Manager.
...
#. Select **[NITSAN] AllSliders** at the field *Include static (from extensions):*
