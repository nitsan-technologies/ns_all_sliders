            ...
            <script>
                (function($) {
                    $('#owl-demo-" . $getContentId . "').owlCarousel({
                        ...
                        loop:' . (isset($settings['loop']) && $settings['loop'] != '' ? $settings['loop'] : (($constant['Conloop'] ?? '') === '' ? 'false' : $constant['Conloop'])) . ',
                        pullDrag:' . (isset($settings['pullDrag']) && $settings['pullDrag'] != '' ? $settings['pullDrag'] : $constant['ConpullDrag']) . ',
                        freeDrag:' . (isset($settings['freeDrag']) && $settings['freeDrag'] != '' ? $settings['freeDrag'] : (($constant['ConfreeDrag'] ?? '') === '' ? 'false' : $constant['ConfreeDrag'])) . ',
                        stagePadding:' . (isset($settings['stagePadding']) && $settings['stagePadding'] != '' ? $settings['stagePadding'] : $constant['ConstagePadding']) . ',
                        merge:' . (isset($settings['merge']) && $settings['merge'] != '' ? $settings['merge'] : (($constant['Conmerge'] ?? '') === '' ? 'false' : $constant['Conmerge'])) . ',
                        mergeFit:' . (isset($settings['mergeFit']) && $settings['mergeFit'] != '' ? $settings['mergeFit'] : $constant['ConmergeFit']) . ',
                        autoWidth:' . (isset($settings['autoWidth']) && $settings['autoWidth'] != '' ? $settings['autoWidth'] : (($constant['ConautoWidth'] ?? '') === '' ? 'false' : $constant['ConautoWidth'])) . ',
                        ...
                        dotsEach:' . (isset($settings['dotsEach']) && $settings['dotsEach'] != '' ? $settings['dotsEach'] : (($constant['CondotsEach'] ?? '') === '' ? 'false' : $constant['CondotsEach'])) . ',
                        dotsData:' . (isset($settings['dotsData']) && $settings['dotsData'] != '' ? $settings['dotsData'] : (($constant['CondotsData'] ?? '') === '' ? 'false' : $constant['CondotsData'])) . ',
                        ...
                        autoplayHoverPause:' . (isset($settings['autoplayHoverPause']) && $settings['autoplayHoverPause'] != '' ? $settings['autoplayHoverPause'] : (($constant['ConautoplayHoverPause'] ?? '') === '' ? 'false' : $constant['ConautoplayHoverPause'])) . ',
                        ...
                        dotsSpeed:' . (isset($settings['dotsSpeed']) && $settings['dotsSpeed'] != '' ? $settings['dotsSpeed'] : (($constant['CondotsSpeed'] ?? '') === '' ? 'false' : $constant['CondotsSpeed'])) . ',
                        ...
                        info:" . (isset($settings['info']) && $settings['info'] != '' ? $settings['info'] : (($constant['Coninfo'] ?? '') === '' ? 'false' : $constant['Coninfo'])) . ',
                        nestedItemSelector:' . (isset($settings['nestedItemSelector']) && $settings['nestedItemSelector'] != '' ? $settings['nestedItemSelector'] : (($constant['ConnestedItemSelector'] ?? '') === '' ? 'false' : $constant['ConnestedItemSelector'])) . ",

                        itemElement:'" . (isset($settings['itemElement']) && $settings['itemElement'] != '' ? $settings['itemElement'] : $constant['ConitemElement']) . "',
                        navContainer:" . (isset($settings['navContainer']) && $settings['navContainer'] != '' ? $settings['navContainer'] : (($constant['ConnavContainer'] ?? '') === '' ? 'false' : $constant['ConnavContainer'])) . ',
                        center:' . (isset($settings['center']) && $settings['center'] != '' ? $settings['center'] : (($constant['Concenter'] ?? '') === '' ? 'false' : $constant['Concenter'])) . ',

                        dotsContainer:' . (isset($settings['dotsContainer']) && $settings['dotsContainer'] != '' ? $settings['dotsContainer'] : (($constant['CondotsContainer'] ?? '') === '' ? 'false' : $constant['CondotsContainer'])) . ',
